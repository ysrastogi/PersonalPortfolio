          ...
          {PROJECTS.map((project, index) => (
            ...
            >
              <a 
                ...
                className="block bg-neutral-50 rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
